package testarchive.application.service.usermanagerservice.test;
...
import com.ams.usermanagement.domain.model.Address;
import com.ams.usermanagement.domain.model.Person;
import com.ams.usermanagement.domain.model.PersonDetail;
...
public class ManageUserService_Test
{
	...
	public static void main(String[] args)
	{
		...
		{
			mus.registerUser(p);
		} catch (com.ams.sharedkernel.application.common.ServiceException e)
		{
