...
public class ServiceCharge implements Serializable
{
	...
	public Money forUsage(ServiceUsage srvcUsage, ServiceRatePolicy
						srvcRatePolicy, Date chargedDate)
	{
		...
		Unit usageUnit = srvcRatePolicy.serviceRate().getSrvcChargeRate().getPerUnit();
		srvcUsage.calculateQuantity(usageUnit);
		return srvcRatePolicy.calculateServiceCharge(null, srvcUsage, chargedDate);
	}
